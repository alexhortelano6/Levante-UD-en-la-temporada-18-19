...
logo1913 <- image_read("./imagenes/1913.gif") %>%  image_annotate(., "1913", size = 40, gravity = "southwest", color = "black") %>% image_scale(.,"700")

logo_transición <- image_read("./imagenes/transición logo.png") %>%
  image_scale(.,"800") %>% image_annotate(., "1939", size = 40, gravity = "southwest", color = "black") %>% image_scale(.,"700")

logo1976 <- image_read("./imagenes/1976.jpg") %>%
  image_scale(.,"500")    %>%  image_annotate(., "1976", size = 40, gravity = "southwest", color = "black") %>% image_scale(.,"700")
...
image_animate(image_scale(evolucion_logo),fps = 0.5) %>% image_scale(.,"700")
